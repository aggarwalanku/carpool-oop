...
$sname=$_POST['sname']; // Get the source 
$dname=$_POST['dname']; // Get the dest

//echo $sname;
//echo $dname;

// This page lists the available options to the user based on his search
?>
...
$user = 'root';
$pass = 'root';
$dbh = mysql_connect('mysql:host=localhost;dbname=carpool', $user, $pass);
